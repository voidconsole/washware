...
int timeSelectorState = 1; // 0: 15 min, 1: 30 min, 2: 45 min
...
void updateTimeSelectorLED() {
  switch (timeSelectorState) {
    case 0: // Low 15min
      blinkLED(TIME_SELECTOR_LED, 1000);
      break;
    case 1: // Mid 30min
      blinkLED(TIME_SELECTOR_LED, 250);
      break;
    case 2: // High 45min
...
void fillWater() {
  int fillTime = 0;
  switch (waterLevelState) {
    case 0: fillTime = 120000; break; // Low 2min
    case 1: fillTime = 300000; break; // Mid 5min
    case 2: fillTime = 600000; break; // High 10min
  }
